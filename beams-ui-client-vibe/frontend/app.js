...
function showEmpty() {
  ...
  e.innerHTML = `<div class="empty-mark">◈</div><h2>Claude Code, inside a beam</h2><p>Create or pick a sandbox on the left. Each session runs Claude Code in the beam, streams the conversation here, and can commit the transcript and memory to GitHub.</p>`;
  T().appendChild(e);
